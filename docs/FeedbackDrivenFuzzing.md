...
```
$ honggfuzz -q --linux_perf_instr -f /usr/share/doc/texlive-doc/latex/ctable/penguin.jpg -- ./djpeg.static ___FILE___
...
...
```
$ honggfuzz -q --linux_perf_branch -f /usr/share/doc/texlive-doc/latex/ctable/penguin.jpg -- ./djpeg.static ___FILE___
...
...
## Unique branch points counting (--linux_perf_ip) / Unique branch pair (edges) counting (--linux_perf_addr) ##
...
```
$ honggfuzz -q --linux_perf_ip -f /usr/share/doc/texlive-doc/latex/ctable/penguin.jpg -- ./djpeg.static ___FILE___
...
